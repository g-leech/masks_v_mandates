...
argparser.add_argument(
    ...
    dest="wearing_parameterisation",
    type=str,
    help="wearing parameterisation",
)
...
if __name__ == "__main__":
    ...
    model_kwargs['wearing_parameterisation'] = args.wearing_parameterisation
    ...
    info_dict["exp_config"] = {'wearing_parameterisation': args.wearing_parameterisation}
