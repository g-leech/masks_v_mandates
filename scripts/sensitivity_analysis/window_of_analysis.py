...
start_date = args.new_dates[0]
end_date = args.new_dates[1]
...
if __name__ == "__main__":
    ...
    featurize_kwargs["start_date"] = start_date
    featurize_kwargs["end_date"] = end_date
    ...
    info_dict["exp_config"] = {"start_date": start_date,
                               "end_date": end_date}
