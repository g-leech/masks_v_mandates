...
argparser.add_argument(
    ...
    dest="cases_delay_disp_mean",
    type=float,
    help="cases_delay_dispersion",
)
...
if __name__ == "__main__":
    ...
    model_kwargs["cases_delay_disp_mean"] = args.cases_delay_disp_mean
    ...
    info_dict["exp_config"] = {"cases_delay_disp_mean": args.cases_delay_disp_mean}
