...
argparser.add_argument(
    "--cases_delay_mean",
    dest="cases_delay_mean",
    type=float,
    help="case delay mean for all countries",
)
...
if __name__ == "__main__":
    ...
    model_kwargs['cases_delay_mean_mean'] = args.cases_delay_mean
    model_kwargs['gi_mean_mean'] = args.gen_int_mean
    ...
    info_dict["exp_config"] = {
        "cases_delay_mean": args.cases_delay_mean,
        "gen_int_mean": args.gen_int_mean,
    }
