...
argparser.add_argument(
    "--R_prior_mean_mean",
    dest="R_prior_mean_mean",
    type=float,
    help="R_prior_mean_mean",
)

argparser.add_argument(
    "--R_prior_mean_scale",
    dest="R_prior_mean_scale",
    type=float,
    help="R_prior_mean_scale",
)
...
if __name__ == "__main__":
    ...
    model_kwargs['R_prior_mean_mean'] = args.R_prior_mean_mean
    model_kwargs['R_prior_mean_scale'] = args.R_prior_mean_scale
    model_kwargs['R_noise_scale'] = args.R_noise_scale

    if 'Mandate' in args.model_type:
        print('Using MandateMobilityModel--CURRENTLY WRONG')
    ...
    basic_R_prior = {
        "mean_mean": args.R_prior_mean_mean,
        "type": "scalar",
        "mean_scale": args.R_prior_mean_scale,
        'noise_scale': args.R_noise_scale
    }
