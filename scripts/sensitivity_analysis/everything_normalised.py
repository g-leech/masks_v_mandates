...
argparser.add_argument(
    ...
    dest="everything_normalised",
    type=bool,
    help="everything_normalised",
)
...
if __name__ == "__main__":
    ...
    if 'Mandate' in args.model_type:
        ...
        print('Using EverythingNormalisedModel')
        with EverythingNormalisedModel(data) as model:
            model.build_model(**model_kwargs)
